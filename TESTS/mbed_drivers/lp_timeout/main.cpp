...
Case cases[] = {
    ...
    Case("500 us delay accuracy (attach)", test_delay_accuracy<AttachTester<LowPowerTimeout>, 500, SHORT_DELTA_US>,
            greentea_failure_handler),
    Case("500 us delay accuracy (attach_us)", test_delay_accuracy<AttachUSTester<LowPowerTimeout>, 500, SHORT_DELTA_US>,
            greentea_failure_handler),

    Case("1 ms delay accuracy (attach)", test_delay_accuracy<AttachTester<LowPowerTimeout>, 1000, SHORT_DELTA_US>,
            greentea_failure_handler),
    Case("1 ms delay accuracy (attach_us)", test_delay_accuracy<AttachUSTester<LowPowerTimeout>, 1000, SHORT_DELTA_US>,
            greentea_failure_handler),
